...
class MainViewModel @ViewModelInject constructor(
    ...
    val readFavoriteRecipes: LiveData<List<FavoritesEntity>> = repository.local.readFavoritesRecipes().asLiveData()
    ...
    private fun insertRecipes(recipesEntity: RecipesEntity) = viewModelScope.launch(Dispatchers.IO) {
     ...
     fun insertFavoritesRecipes(favoritesEntity: FavoritesEntity) = viewModelScope.launch(Dispatchers.IO) {
    ...
    fun deleteFavoritesRecipes(favoritesEntity: FavoritesEntity) = viewModelScope.launch(Dispatchers.IO) {
